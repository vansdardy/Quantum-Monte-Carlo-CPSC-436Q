...
Ref.~\cite{foulkes_mitas_needs_rajagopal_01}, Sec.~II~C.
...
for small systems and show no fundamental loss of accuracy for larger systems (Ref.~\cite{foulkes_mitas_needs_rajagopal_01}, Sec.~I).  
...
% dramatically improving Monte Carlo efficiency. These limitations are further discussed in Ref.~\cite{foulkes_mitas_needs_rajagopal_01}, Sec.~III~C.
...
component of the trial wavefunction are discussed in Ref.~\cite{foulkes_mitas_needs_rajagopal_01},
Secs.~II~C and IV~B.
...
As discussed in Sec.~VII of \cite{foulkes_mitas_needs_rajagopal_01}, these properties make HF orbitals reliable
